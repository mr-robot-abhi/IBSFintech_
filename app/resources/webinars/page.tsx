...
const WebinarsPage = () => {
  const upcomingWebinars = [
    {
      id: 1,
      title: 'The Future of Digital Treasury in 2025',
      date: '2025-09-15',
      time: '14:00',
      duration: '60 mins',
      speaker: 'Sarah Johnson',
      speakerTitle: 'Head of Digital Transformation',
      attendees: 125,
      description: 'Join us as we explore the latest trends and technologies shaping the future of treasury management.',
      image: '/images/webinars/digital-treasury.jpg',
      category: 'Treasury Management'
    },
    {
      id: 2,
      title: 'Mastering FX Risk in Volatile Markets',
      date: '2025-09-22',
      time: '15:30',
      duration: '45 mins',
      speaker: 'Michael Chen',
      speakerTitle: 'Senior FX Strategist',
      attendees: 89,
      description: 'Learn effective strategies to manage foreign exchange risk in today\'s dynamic market conditions.',
      image: '/images/webinars/fx-risk.jpg',
      category: 'Risk Management'
    },
    {
      id: 3,
      title: 'Blockchain in Trade Finance: Real-World Applications',
      date: '2025-10-05',
      time: '11:00',
      duration: '90 mins',
      ...
      attendees: 67,
      description: 'Discover how blockchain technology is revolutionizing trade finance operations globally.',
      image: '/images/webinars/blockchain-trade.jpg',
      category: 'Technology'
    },
  ];
  ...
  const pastWebinars = [
    {
      id: 4,
      title: 'Treasury Automation: From Strategy to Implementation',
      date: '2025-08-10',
      duration: '75 mins',
      speaker: 'David Kim',
      attendees: 143,
      description: 'A comprehensive guide to implementing treasury automation in your organization.',
      image: '/images/webinars/treasury-automation.jpg',
      category: 'Treasury Automation',
      recordingUrl: '#'
    },
    {
      id: 5,
      title: 'ESG Integration in Treasury Operations',
      date: '2025-07-28',
      duration: '60 mins',
      speaker: 'Lisa Wong',
      attendees: 98,
      description: 'How to incorporate Environmental, Social, and Governance factors into your treasury strategy.',
      image: '/images/webinars/esg-treasury.jpg',
      category: 'ESG',
      recordingUrl: '#'
    },
    {
      id: 6,
      title: 'Liquidity Management in Uncertain Times',
      date: '2025-07-15',
      duration: '50 mins',
      speaker: 'Robert Taylor',
      attendees: 112,
      description: 'Strategies for optimizing liquidity management during economic uncertainty.',
      image: '/images/webinars/liquidity-management.jpg',
      category: 'Liquidity',
      recordingUrl: '#'
    },
  ];
