...
import { ArrowRight, BarChart, Bell, FileText, Layers, LineChart, Shield, TrendingUp, Zap, Globe, DollarSign, AlertTriangle, CheckCircle } from 'lucide-react';
                ...
                <div>
                  <ul className="space-y-4 text-gray-700 mb-8">
                    <li className="flex items-start">
                      <CheckCircle className="text-blue-600 mr-3 mt-1 h-5 w-5 flex-shrink-0" />
